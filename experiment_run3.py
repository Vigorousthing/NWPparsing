...
data_type = "LDAPS"
fold_type = "unis"
time_interval = ["2019-04-11 00", "2019-04-18 00"]
...
var_list = ["NDNSW", "UGRD", "VGRD", "TMP", "SPFH", "RH", "DPT"]
...
#
# df = ftp_accessor.make_historical_prediction_data(2, "daily")
# print(df)
...
df = ftp_accessor.make_historical_prediction_data(36, comparison_type="hourly")
...
if __name__ == "__main__":
    # nwp_file = pygrib.open("l015_v070_erlo_unis_h002.2019042318.gb2")
    # lat_grid, lon_grid = nwp_file[4].latlons()
    # point = (37.57142, 126.9658)
    pass
    # analyzer = NwpGridAnalyzer()
    # analyzer.set_lat_lon_grid(lat_grid, lon_grid)
    # analyzer.plot_base_point(point[0], point[1])

    # print(len(lat_grid[0]))
