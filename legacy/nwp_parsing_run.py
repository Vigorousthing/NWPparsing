...
data_type = "LDAPS"
fold_type = "unis"
# time_interval = ["2019-04-10 10", "2019-04-17 00"]
# time_interval = ["2019-05-15 10", "2019-05-22 00"]

# time_interval = ["2019-03-16 00", "2019-03-26 23"]
...
time_interval = ["2019-08-10 00", "2019-08-10 03"]
